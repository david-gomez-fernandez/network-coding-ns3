...
public:
	...
	inline void SetDynamicAverageTime (bool flag) {m_dynamicAverageTime = flag;}
	inline bool GetDynamicAverageTime () {return m_dynamicAverageTime;}
