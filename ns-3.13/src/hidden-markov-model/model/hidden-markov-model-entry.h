...
private:
	...
	coefSet_t m_changeStateMatrix;					//Cumulative probabilities of changing the states (used at ChangeState method)
	...
	bool m_dynamicAverageTime;						//Allow the dynamic average time analysis
