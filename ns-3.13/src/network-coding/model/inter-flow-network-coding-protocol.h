...
#ifndef INTER_FLOW_NETWORK_CODING_PROTOCOL_H_
#define INTER_FLOW_NETWORK_CODING_PROTOCOL_H_
...
#include "inter-flow-network-coding-header.h"
...
//	struct InterFlowNetworkCodingStatistics  {
//
 ...
 */
class InterFlowNetworkCodingProtocol: public NetworkCodingL4Protocol {
public:
	//Callbacks
	 ...
	 */
	typedef Callback<void, Ptr<Packet>, u_int8_t, u_int32_t, Ipv4Address, Ipv4Address, u_int8_t, u_int8_t, bool> InterFlowNetworkCodingCallback;
...
//	struct NetworkCodingEntry;
	 ...
	 * Default constructor
	 */
	InterFlowNetworkCodingProtocol();

	/**
	 * Default destructor
	 */
	virtual ~InterFlowNetworkCodingProtocol();

	/**
	 *	Locate in which node the InterFlowNetworkCodingProtocol object is stored
	 ...
	 */
	void ReceiveFromUpperLayer (Ptr<Packet> packet, Ipv4Address source, Ipv4Address destination, uint8_t protocol, Ptr<Ipv4Route> route);

	/**
	 *  Send a packet (coded or not) downwards.
	 *  NOTE: This method will be invoked at the InterFlowNetworkCodingBuffer class.
	 */
	void SendDown ();
	 ...
	 */
	Ptr<Packet> DecodeAttempt (Ptr <Packet> packet, InterFlowNetworkCodingHeader header, Ipv4Header &ipHeader);
	...
	inline void SetInterFlowNetworkCodingCallback (InterFlowNetworkCodingCallback cb) {m_interFlowNetworkCodingCallback = cb;}

	/**
	 * Enable/disable
	 * \param flag Boolean that enables/disables the coding role of the node
	 */
	inline void SetCodingNode (bool flag) {m_codingNode = flag;}

	/**
	 * Enable/disable the ACK encapsulation scheme (By default, this operation is disabled)
	 * \param flag Boolean that sets the ACK encapsulation
	 */
     ...
     * \returns The InterFlowNetworkCodingBuffer object
     */
    inline Ptr<InterFlowNetworkCodingBuffer> GetNetworkCodingBuffer () {return m_ncBuffer;}

private:
	//Buffer parameter configuration
	Ptr<InterFlowNetworkCodingBuffer> m_ncBuffer;						//InterFlowNetworkCodingBuffer associated to the NetworkCodingL4Protocol layer

	//Set a node as a coding entity (or not)
	bool m_codingNode;
	...
	InterFlowNetworkCodingCallback m_interFlowNetworkCodingCallback;	//Callback used to trace the main results achieved
...
//	InterFlowNetworkCodingStatistics m_stats;
...
#endif /* INTER_FLOW_NETWORK_CODING_PROTOCOL_H_ */
