...
NS_LOG_COMPONENT_DEFINE ("InterFlowNetworkCodingHeader");

NS_OBJECT_ENSURE_REGISTERED (InterFlowNetworkCodingHeader);

InterFlowNetworkCodingHeader::Item::Item (const Ipv4Address destination,
...
InterFlowNetworkCodingHeader::AckInfo::AckInfo (const Ipv4Address destination,
...
InterFlowNetworkCodingHeader::InterFlowNetworkCodingHeader()
{
...
TypeId
InterFlowNetworkCodingHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::InterFlowNetworkCodingHeader")
    .SetParent<Header> ()
    .AddConstructor<InterFlowNetworkCodingHeader> ()
  ;
  return tid;
}
TypeId
InterFlowNetworkCodingHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

//Getters/setters
void InterFlowNetworkCodingHeader::SetProtocolNumber (u_int8_t protocol)
{
	m_protocol = protocol;
}

u_int32_t InterFlowNetworkCodingHeader::GetProtocolNumber () const
{
	return m_protocol;
}

void InterFlowNetworkCodingHeader::SetCodedPackets (u_int8_t codedPackets)
{
	m_codedPackets = codedPackets;
}

u_int8_t InterFlowNetworkCodingHeader::GetCodedPackets () const
{
	return m_codedPackets;
}

void InterFlowNetworkCodingHeader::SetEmbeddedAcks (u_int8_t embeddedAcks)
{
	m_embeddedAcks = embeddedAcks;
}

u_int8_t InterFlowNetworkCodingHeader::GetEmbeddedAcks () const
{
	return m_embeddedAcks;
}

void InterFlowNetworkCodingHeader::SetPacketType (u_int8_t type)
{
	m_type = type;
}

u_int8_t InterFlowNetworkCodingHeader::GetPacketType() const
{
	return m_type;
}
...
uint32_t InterFlowNetworkCodingHeader::GetSerializedSize (void) const
{
	NS_LOG_FUNCTION (this);
...
void InterFlowNetworkCodingHeader::Serialize (Buffer::Iterator start) const
{
	NS_LOG_FUNCTION (this);
...
uint32_t InterFlowNetworkCodingHeader::Deserialize (Buffer::Iterator start)
{
	NS_LOG_FUNCTION (this);
	Buffer::Iterator i = start;
	u_int8_t count;
...
void InterFlowNetworkCodingHeader::Print (std::ostream &os) const
{
	u_int8_t i;
