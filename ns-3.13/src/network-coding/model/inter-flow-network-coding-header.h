...
#ifndef INTER_FLOW_NETWORK_CODING_HEADER_H_
#define INTER_FLOW_NETWORK_CODING_HEADER_H_
...
class InterFlowNetworkCodingHeader:  public Header
{
public:
	/**
	 * Attribute handler
	 ...
	 * Default constructor
	 */
	InterFlowNetworkCodingHeader ();
	/**
	 * Default destructor
	 */
	virtual ~InterFlowNetworkCodingHeader ();
